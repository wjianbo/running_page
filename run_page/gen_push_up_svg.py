...
from gpxtrackposter import push_up_github_drawer
...
def main():
    ...
    if args.from_db:
        ...
        tracks = loader.load_training_tracks_from_db(SQL_FILE, args.type == "grid")
    else:
